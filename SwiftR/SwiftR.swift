...
public final class SwiftR: NSObject {
    ...
    class func stringify(_ obj: AnyObject) -> String? {
...
open class SignalR: NSObject, SwiftRWebDelegate {
    ...
    open func send(_ data: AnyObject?) {
        var json = "null"
...
open class Hub {
    ...
    var invokeHandlers: [String: (_ result: AnyObject?, _ error: AnyObject?) -> ()] = [:]
    ...
    open func invoke(_ method: String, arguments: [AnyObject]? = nil, callback: ((_ result: AnyObject?, _ error: AnyObject?) -> ())? = nil) {
